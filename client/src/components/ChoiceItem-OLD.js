...
import { BigButton, SmallButton } from './common/base/ButtonBase';
import styled from 'styled-components';
import Markdown from 'markdown-to-jsx';

const ChoiceItem_OLD = ({
  index,
  allowMarkdown,
  choiceText,
  isAnswer,
...
export default ChoiceItem_OLD;

ChoiceItem_OLD.propTypes = {
